                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <h5 class="card-title">Service Categories <span class="text-muted fw-normal ms-2">(1)</span></h5>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                    ...
                                    <div>
                                        <a href="#" class="btn bg-primary text-light"><i class="bx bx-plus me-1"></i> Add Service</a>
                                    </div>
