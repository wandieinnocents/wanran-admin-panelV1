                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body bg-gradient bg-success">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-light mb-3 lh-1 d-block text-truncate">My Wallet</span>
                                        ...
                                        <div class="text-nowrap">
                                            <span class="badge bg-soft-primary text-success">+$20.9k</span>
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body bg-gradient bg-primary">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-light mb-3 lh-1 d-block text-truncate">Number of Trades</span>
                                                <h4 class="mb-3 text-light">
                                        ...
                                        <div class="text-nowrap">
                                            <span class="badge bg-soft-danger text-light">-29 Trades</span>
                                            <span class="ms-1 text-light font-size-13">Since last week</span>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                            </div><!-- end col-->
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body bg-gradient bg-danger">
                                        ...
                                        <div class="text-nowrap">
                                            <span class="badge bg-soft-primary text-success">+2.95%</span>
                                            <span class="ms-1 text-light font-size-13">Since last week</span>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
